---
name: antrag-s00000000392
description: Führt Antragstellende durch „Antrag auf Erteilung einer unionsrechtlichen Aufenthaltserlaubnis für Drittstaatsangehörige im Ausnahmefall bei Vorliegen eines ganz besonderen Abhängigkeitsverhältnisses zu einem minderjährigen Unionsbürger" (FIM S00000000392 1.1.0). Fragt nur, was in der jeweiligen Situation gebraucht wird, und begründet jede Frage mit ihrer Rechtsgrundlage.
---

# Antrag auf Erteilung einer unionsrechtlichen Aufenthaltserlaubnis für Drittstaatsangehörige im Ausnahmefall bei Vorliegen eines ganz besonderen Abhängigkeitsverhältnisses zu einem minderjährigen Unionsbürger

- **FIM-ID:** `S00000000392 1.1.0` · **Reifegrad:** fachlich freigegeben (gold)
- **Rechtsgrundlagen:** Art. 20 AEUV
- **Kompiliert:** 2026-08-13T15:36:38Z aus https://fimportal.de/api/v1/schemas/S00000000392/1.1.0/xdf
...
> **Hinweis:** Die zugehörige Leistung konnte nicht zweifelsfrei zugeordnet werden (Rechtsgrundlage stimmt nicht überein (D99000001629)). Zu Fristen, Kosten, Unterlagen und Zuständigkeit daher keine Auskunft geben, sondern an die zuständige Stelle verweisen.
